...
sealed class ThreadColumnList : ColumnList<ThreadLifespan>() {
    ...
    val mark =
        Column<ThreadLifespan, Boolean>(
            ...
            columnCustomization = {
                ...
                headerRenderer =
                    DefaultTableRenderer(StringValues.EMPTY) {
    ...
    val cpu =
        Column<ThreadLifespan, Double?>(
            header = "CPU",
            columnCustomization = {
                minWidth = 60
                cellRenderer =
                    DefaultTableRenderer { value ->
...
class ThreadModel(val threadData: List<ThreadLifespan>) : AbstractTableModel() {
    ...
    operator fun <T> get(
        row: Int,
        column: Column<ThreadLifespan, T>,
    ): T {
    ...
    data object MultiThreadColumns : ThreadColumnList() {
        ...
        override val filterableColumns =
            listOf(
                system,
                pool,
            )

        override val markableColumns =
            listOf(
                system,
                pool,
                blocker,
    ...
    data object SingleThreadColumns : ThreadColumnList() {
        val state =
            Column<ThreadLifespan, ThreadState>(
                "State",
                columnCustomization = {
                    minWidth = 105
                    maxWidth = 105
